...
parlist = [
    ...
    {'name':'basal_red', 'lower_limit':1.,'upper_limit':3.},
    {'name':'beta_red', 'lower_limit':1.,'upper_limit':4.},
    {'name':'K_RED', 'lower_limit':-3.0,'upper_limit':3.0},
    ...
    #{'name':'F_GREEN', 'lower_limit':-3.0,'upper_limit':2.0},

    {'name':'alpha_green', 'lower_limit':0.,'upper_limit':4.},
    {'name':'basal_green', 'lower_limit':1.,'upper_limit':3.},
    {'name':'beta_green', 'lower_limit':1.,'upper_limit':4.},
    {'name':'K_GREEN', 'lower_limit':-1.0,'upper_limit':4.0},
    ...
    {'name':'K_IPTG', 'lower_limit':-1.0,'upper_limit':3.0},
    {'name':'K_IPTG2', 'lower_limit':2.0,'upper_limit':7.0}#,
